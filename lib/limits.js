...
export const PLANS = {
  free: { cloudBytes: 100 * MB, imageBytes: 50 * MB,  notebooks: Infinity, versionDays: 0,  sharing: false },
  pro:  { cloudBytes: 10 * GB,  imageBytes: 5 * GB,   notebooks: Infinity, versionDays: 30, sharing: true  },
  team: { cloudBytes: 100 * GB, imageBytes: 50 * GB,  notebooks: Infinity, versionDays: 90, sharing: true  },
}
